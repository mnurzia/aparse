...
MN_INTERNAL aparse_error aparse__arg_bool_cb(
...
MN_INTERNAL void aparse__arg_store_int_destroy(aparse__arg* arg);
MN_INTERNAL aparse_error aparse__arg_store_int_cb(
  aparse__arg* arg, aparse__state* state, mn_size sub_arg_idx,
  const char* text, mn_size text_size);
...
MN_INTERNAL aparse_error aparse__arg_str_cb(
  aparse__arg* arg, aparse__state* state, mn_size sub_arg_idx,
  const char* text, mn_size text_size);
...
MN_INTERNAL void aparse__arg_str_destroy(aparse__arg* arg) { MN__UNUSED(arg); }
...
MN_INTERNAL void aparse__arg_int_destroy(aparse__arg* arg);
MN_INTERNAL aparse_error aparse__arg_int_cb(
  aparse__arg* arg, aparse__state* state, mn_size sub_arg_idx,
  const char* text, mn_size text_size);
...
MN_INTERNAL void aparse__arg_int_destroy(aparse__arg* arg) { MN__UNUSED(arg); }

MN_INTERNAL void aparse__arg_help_destroy(aparse__arg* arg);
MN_INTERNAL aparse_error aparse__arg_help_cb(
  aparse__arg* arg, aparse__state* state, mn_size sub_arg_idx,
  const char* text, mn_size text_size);
...
MN_INTERNAL aparse_error aparse__arg_version_cb(
  aparse__arg* arg, aparse__state* state, mn_size sub_arg_idx,
  const char* text, mn_size text_size);
...
MN_INTERNAL aparse_error aparse__arg_custom_cb(
  aparse__arg* arg, aparse__state* state, mn_size sub_arg_idx,
  const char* text, mn_size text_size);
